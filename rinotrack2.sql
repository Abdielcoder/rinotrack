...
-- Tiempo de generación: 20-08-2025 a las 18:44:09
...
(29, 'Metas promotoria etapa 1', 'Seguimiento al proyecto, consulta de promotoria.', 5, 1, 'open', 1, 1, 0.00, '2025-08-13 17:35:38', '2025-08-18 23:57:50', 11, 300, 'automatic', '2025-09-30', 0),
...
--
ALTER TABLE `Tasks`
  MODIFY `task_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=243;

--
-- AUTO_INCREMENT de la tabla `Task_Assignments`
--
ALTER TABLE `Task_Assignments`
  MODIFY `assignment_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=332;
...
--
ALTER TABLE `Task_History`
  MODIFY `history_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=631;
