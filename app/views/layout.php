    ...
    <header class="leader-nav">
        <div class="leader-nav__inner">
            ...
            <nav class="leader-nav__menu">
                ...
                <a href="?route=logout" class="leader-nav__link leader-nav__logout" title="Cerrar Sesión" onclick="return confirm('¿Estás seguro de que quieres cerrar sesión?')">
        ...
        .leader-nav__logout { color: #dc2626 !important; }
        .leader-nav__logout i { color: #dc2626 !important; }
        .leader-nav__logout:hover { background: #fef2f2 !important; border-color: #fecaca !important; color: #dc2626 !important; }
        .leader-nav__logout:hover i { color: #dc2626 !important; }
